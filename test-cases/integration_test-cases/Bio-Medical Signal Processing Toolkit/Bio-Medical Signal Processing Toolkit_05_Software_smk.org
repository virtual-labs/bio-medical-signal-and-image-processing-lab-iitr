...
* Objective
  - To view the Software used for the Bio-Medical Signal Processing Toolkit experiment
...
* Post conditions
  - Nil
* Test Steps
  1. Click on the Software used link 
  2. It should re-direct to the Software used page

* Expected result
  1. Software used page should be opened
